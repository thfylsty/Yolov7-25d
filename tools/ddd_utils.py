...
def compute_box_3d(dim, location, rotation_y):
  ...
  # rotation_x = -15/180*3.14
  rotation_x = 0/180*3.14
  c, s = np.cos(rotation_x), np.sin(rotation_x)
  ...
  corners_3d = np.dot(R2, corners_3d)
...
def draw_box_3d(image, corners, c=(0, 0, 255),cat=None,txt=""):
  face_idx = [[0,1,5,4],
              [1,2,6, 5],
              [2,3,7,6],
              [3,0,4,7]]
  ...
  cv2.putText(image,txt,(int(corners[:, 0].mean()), int(corners[:, 1].mean())),cv2.FONT_HERSHEY_SIMPLEX,1,(0, 255, 255), 1)
...
if __name__ == '__main__':
  ...
  print('rot_y2alpha', rot_y2alpha(alpha2rot_y(alpha, ct[0], calib[0, 2], calib[0, 0]), ct[0], calib[0, 2], calib[0, 0]))
  print('rotation_y', alpha2rot_y(rot_y2alpha(rotation_y, ct[0], calib[0, 2], calib[0, 0]), ct[0], calib[0, 2], calib[0, 0]))